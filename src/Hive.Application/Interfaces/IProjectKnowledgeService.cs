...
public interface IProjectKnowledgeService
{
    ...
    Task<IReadOnlyList<KnowledgeProgressionEntryDto>> GetProgressionByDirectReportAsync(Guid directReportId, CancellationToken cancellationToken = default);
    Task<IReadOnlyList<KnowledgeProgressionEntryDto>> GetProgressionByProjectAsync(Guid projectId, CancellationToken cancellationToken = default);
}
