...
public class Project
{
    ...
    public Project(string name, string? description = null, DateTime? startDate = null, DateTime? targetEndDate = null)
    {
        ValidateName(name);
    ...
    public void Update(string name, string? description, DateTime? startDate, DateTime? targetEndDate)
    {
        ValidateName(name);
